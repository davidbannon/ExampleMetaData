...
This particular file is the same code as mentioned above but has all network
operations ifdef'ed out. Varstly bigger than it needs but easy. DRB Nov 2022
...
type
    ...
    TExampleData = class
        private
            ...
            {$ifndef EXMETAFILE}// Gets a Full URL and returns with St containing content, usually as JSON
...
{$ifdef EXMETAFILE}         // Not used in ExMetaFile but needed to compile
    cExamplesDir='';
{$endif}
